...
Hi kevin here,
on my second revison for this code I change a lot of things to optimize the code
for example, whereever there was a queryselector I changed it for getElementByid or getElementsByClassName since they 
are less expensive. Also, I moved and store some line of codes outside the loops and stored them in variable to have them already prepared before the loops starts

I also added backface-visibility: hidden in the css as suggested in the forums of Udacity
...
var resizePizzas = function(size) { 
  ...
  function changeSliderLabel(size) {//CHANGE query selector to getElementById ###########
    switch(size) {
      case "1":
  ...
  function determineDx (elem, size) {
    ...
    var windowWidth = document.getElementById("randomPizzas").offsetWidth;// CHANGE query selector to getElementById ###########
...
function updatePositions() {
  ...
  var scroll = document.body.scrollTop; // stored inside variable
  var items = document.getElementsByClassName('mover');// change query to className
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var el = document.getElementById("movingPizzas1"); // saved the target element in a variable

  for (var i = 0; i < 60; i++) {// change 200 to 60 
